...
class RecipeImportFunctionalTest extends WebTestCase
{
    ...
    private function getValidCsvContent(): string
    {
        return "title,description,servings,prepMinutes,cookMinutes,image,ingredients,steps\n" .
               "\"Pasta Carbonara\",\"Une délicieuse recette de pâtes à la carbonara traditionnelle\",4,15,20,\"carbonara.jpg\",\"Pâtes:400:g|Œufs:4:pièce|Lardons:200:g|Parmesan:100:g|Poivre noir:1:pincée\",\"1. Faire cuire les pâtes dans l'eau bouillante salée|2. Faire revenir les lardons dans une poêle|3. Battre les œufs avec le parmesan râpé|4. Mélanger les pâtes chaudes avec les lardons|5. Ajouter le mélange œufs-parmesan hors du feu|6. Assaisonner avec le poivre noir\"\n" .
